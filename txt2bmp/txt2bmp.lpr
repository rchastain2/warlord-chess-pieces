...
begin
  ...
  begin
    ...
    LWhiteName := Format('w%s.bmp', [LLetter]);
    LBlackName := Format('b%s.bmp', [LLetter]);

    LWhiteBitmap := TBGRABitmap.Create(48, 48, CSSMagenta);
    LBlackBitmap := TBGRABitmap.Create(48, 48, CSSMagenta);
